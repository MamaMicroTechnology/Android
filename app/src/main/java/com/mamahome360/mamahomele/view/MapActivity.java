...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    String userName, Subward_id, latlon, mode;
    LatLng latLng;
        ...
        if (broadcastReceiver == null) {
            broadcastReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    LatLng latLng = new LatLng(Double.parseDouble(Objects.requireNonNull(intent.getExtras()).getString("lat")),
...
//                          String da2= date2.toString();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Calendar calendar = Calendar.getInstance();
        //date1 = calendar.getTime();
        //Toast.makeText(getApplicationContext(), date1.toString()+","+date2.toString(), Toast.LENGTH_LONG).show();
...
//        //final String msg;
//
//        Call<ResponseBody> call6 = userService.gettime();
//
...
private void tracklogout(String userid,String tracklogout){
        Call call4 = userService.tracklogout(userid,tracklogout);
