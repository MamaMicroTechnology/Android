...
public class PendingOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_pendingOrders = view.findViewById(R.id.rv_pendingOrders);
        ...
        rv_pendingOrders.setLayoutAnimation(controller);
        rv_pendingOrders.setLayoutManager(staggeredGridLayoutManager);
    ...
    private void getOrders(){
        ...
        Call<PendingOrders> orderCall = APIKeys.PendingOrders(User_ID);

        orderCall.enqueue(new Callback<PendingOrders>() {
            @Override
            public void onResponse(Call<PendingOrders> call, Response<PendingOrders> response) {

                PendingOrders pendingOrders = response.body();
                Orders = new ArrayList<>(Arrays.asList(pendingOrders.getPendingOrders()));
                pendingOrdersAdapter = new PendingOrdersAdapter(getContext(), Orders);
                rv_pendingOrders.setAdapter(pendingOrdersAdapter);
                swipeLayout.setRefreshing(false);
                progressDialog.cancel();
            }

            @Override
            public void onFailure(Call<PendingOrders> call, Throwable t) {
